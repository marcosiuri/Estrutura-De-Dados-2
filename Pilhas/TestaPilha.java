...
public class Pilha {
    // Criando uma pilha usando a classe Stack
    private Stack<Integer> stack = new Stack<>();

    // Método para empilhar (adicionar no topo da pilha)
    ...
    // Método para imprimir elementos desempilhando a pilha
    ...
    // Método para verificar o topo da pilha (último elemento adicionado)
    ...
    // Método para verificar se um elemento existe na pilha
    ...
    // Método para desempilhar (remover do topo da pilha)
